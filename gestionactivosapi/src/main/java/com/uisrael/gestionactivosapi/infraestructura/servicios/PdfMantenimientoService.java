...
public class PdfMantenimientoService {
    ...
    public byte[] generarInforme(MantenimientoManualResponseDTO mantenimiento, Equipos equipo,
            Custodios custodio, Usuarios tecnico, List<Path> imagenes) {
    ...
    private void escribirDetalleActivo(Document doc, MantenimientoManualResponseDTO mantenimiento, Equipos equipo)
            throws Exception {
    ...
    private void escribirFirmas(Document doc, MantenimientoManualResponseDTO mantenimiento, Custodios custodio,
            Usuarios tecnico) throws Exception {
