...
public class AsignacionActivosResponseDTO {
    ...
    public List<ActivoInventarioResponseDTO> getActivos() { return activos; }
    public void setActivos(List<ActivoInventarioResponseDTO> activos) { this.activos = activos; }
    public List<CustodiasResponseDTO> getCustodias() { return custodias; }
    public void setCustodias(List<CustodiasResponseDTO> custodias) { this.custodias = custodias; }
}
