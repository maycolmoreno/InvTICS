...
public class StockConsumibleResponseDTO {
    ...
    public Integer getIdStockConsumibleBodega() { return idStockConsumibleBodega; }
    public void setIdStockConsumibleBodega(Integer idStockConsumibleBodega) { this.idStockConsumibleBodega = idStockConsumibleBodega; }
